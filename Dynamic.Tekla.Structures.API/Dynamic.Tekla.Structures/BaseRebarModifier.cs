...
namespace Dynamic.Tekla.Structures.Model
{
    ...
    public sealed class BaseRebarModifier 
    {
		...
		{
			get => new Dynamic.Tekla.Structures.Model.RebarSet(baserebarmodifier.Father.GetTSObject());
			set { baserebarmodifier.Father = value.GetTSObject(); }
		}

		public Dynamic.Tekla.Structures.Model.Contour Curve
		{
			get => new Dynamic.Tekla.Structures.Model.Contour(baserebarmodifier.Curve.GetTSObject());
			set { baserebarmodifier.Curve = value.GetTSObject(); }
		}

		public Dynamic.Tekla.Structures.Model.BarsAffectedEnum BarsAffected
		{
			get => Dynamic.Tekla.Structures.Model.BarsAffectedEnum_.FromTSObject(baserebarmodifier.BarsAffected);
			set { baserebarmodifier.BarsAffected = Dynamic.Tekla.Structures.Model.BarsAffectedEnum_.FromTSObject(value); }
		}
		...
		{
			get => new Dynamic.Tekla.Structures.Identifier(baserebarmodifier.Identifier.GetTSObject());
        ...
        {
            this.baserebarmodifier =  new Tekla.Structures.Model.BaseRebarModifier();
        }
        ...
        public BaseRebarModifier(dynamic tsObject)
        {
			...
			this.BarsAffected = Dynamic.Tekla.Structures.Model.BarsAffectedEnum_.FromTSObject(baserebarmodifier.BarsAffected);
		...
		public System.Boolean GetAllUserProperties(ref System.Collections.Hashtable values)
			 => baserebarmodifier.GetAllUserProperties(ref values);

		public System.Boolean GetIntegerUserProperties(ref System.Collections.Hashtable values)
			 => baserebarmodifier.GetIntegerUserProperties(ref values);

		public System.Boolean GetDoubleUserProperties(ref System.Collections.Hashtable values)
			 => baserebarmodifier.GetDoubleUserProperties(ref values);

		public System.Boolean GetStringUserProperties(ref System.Collections.Hashtable values)
			 => baserebarmodifier.GetStringUserProperties(ref values);
		...
		public System.Boolean GetAllReportProperties(System.Collections.ArrayList stringNames, System.Collections.ArrayList doubleNames, System.Collections.ArrayList integerNames, ref System.Collections.Hashtable values)
			 => baserebarmodifier.GetAllReportProperties(stringNames, doubleNames, integerNames, ref values);
		...
		public System.Boolean GetIntegerReportProperties(System.Collections.ArrayList names, ref System.Collections.Hashtable values)
			 => baserebarmodifier.GetIntegerReportProperties(names, ref values);
		...
		public System.Boolean GetDoubleReportProperties(System.Collections.ArrayList names, ref System.Collections.Hashtable values)
			 => baserebarmodifier.GetDoubleReportProperties(names, ref values);
		...
		public System.Boolean GetStringReportProperties(System.Collections.ArrayList names, ref System.Collections.Hashtable values)
			 => baserebarmodifier.GetStringReportProperties(names, ref values);

		public System.Boolean GetUserProperty(System.String name, ref System.String value)
			 => baserebarmodifier.GetUserProperty(name, ref value);

		public System.Boolean GetReportProperty(System.String name, ref System.String value)
			 => baserebarmodifier.GetReportProperty(name, ref value);
		...
		public System.Boolean GetDynamicStringProperty(System.String name, ref System.String value)
			 => baserebarmodifier.GetDynamicStringProperty(name, ref value);
		...
		public System.Boolean GetPhase(ref Dynamic.Tekla.Structures.Model.Phase phase)
			 => baserebarmodifier.GetPhase(ref phase.GetTSObject());
