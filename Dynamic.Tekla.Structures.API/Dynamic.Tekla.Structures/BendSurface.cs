...
namespace Dynamic.Tekla.Structures.Model
{
    ...
    public sealed class BendSurface 
    {
		...
		{
			get => new Dynamic.Tekla.Structures.Geometry3d.LineSegment(bendsurface.SideBoundary1.GetTSObject());
			set { bendsurface.SideBoundary1 = value.GetTSObject(); }
		}

		public Dynamic.Tekla.Structures.Geometry3d.LineSegment SideBoundary2
		{
			get => new Dynamic.Tekla.Structures.Geometry3d.LineSegment(bendsurface.SideBoundary2.GetTSObject());
		...
		public System.Boolean Equals(System.Object obj)
			 => bendsurface.Equals(obj);

		public System.Int32 GetHashCode()
			 => bendsurface.GetHashCode();

		public System.Type GetType()
			 => bendsurface.GetType();

		public System.String ToString()
			 => bendsurface.ToString();
