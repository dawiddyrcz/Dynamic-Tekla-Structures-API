...
namespace Dynamic.Tekla.Structures.Model.Collaboration
{
    ...
    public sealed class IFC2X3_ParametricObject_IShapeProfile 
    {
		...
		{
			get => new Dynamic.Tekla.Structures.Geometry3d.Point(ifc2x3_parametricobject_ishapeprofile.Origin.GetTSObject());
			set { ifc2x3_parametricobject_ishapeprofile.Origin = value.GetTSObject(); }
		}

		public Dynamic.Tekla.Structures.Geometry3d.Vector xDir
		{
			get => new Dynamic.Tekla.Structures.Geometry3d.Vector(ifc2x3_parametricobject_ishapeprofile.xDir.GetTSObject());
		...
		{
			get => new Dynamic.Tekla.Structures.Geometry3d.Vector(ifc2x3_parametricobject_ishapeprofile.Extrusion.GetTSObject());
        ...
        {
            this.ifc2x3_parametricobject_ishapeprofile =  new Tekla.Structures.Model.Collaboration.IFC2X3_ParametricObject_IShapeProfile();
        }
		...
		public System.Boolean Equals(System.Object obj)
			 => ifc2x3_parametricobject_ishapeprofile.Equals(obj);

		public System.Int32 GetHashCode()
			 => ifc2x3_parametricobject_ishapeprofile.GetHashCode();

		public System.Type GetType()
			 => ifc2x3_parametricobject_ishapeprofile.GetType();

		public System.String ToString()
			 => ifc2x3_parametricobject_ishapeprofile.ToString();
