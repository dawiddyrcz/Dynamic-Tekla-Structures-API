...
namespace Dynamic.Tekla.Structures.Model
{
    ...
    public sealed class LoftedPlate 
    {
		...
		{
			get => new Dynamic.Tekla.Structures.Model.Profile(loftedplate.Profile.GetTSObject());
			set { loftedplate.Profile = value.GetTSObject(); }
		}

		public Dynamic.Tekla.Structures.Model.Material Material
		{
			get => new Dynamic.Tekla.Structures.Model.Material(loftedplate.Material.GetTSObject());
			set { loftedplate.Material = value.GetTSObject(); }
		}

		public Dynamic.Tekla.Structures.Model.DeformingData DeformingData
		{
			get => new Dynamic.Tekla.Structures.Model.DeformingData(loftedplate.DeformingData.GetTSObject());
			set { loftedplate.DeformingData = value.GetTSObject(); }
		}

		public Dynamic.Tekla.Structures.Model.NumberingSeries PartNumber
		{
			get => new Dynamic.Tekla.Structures.Model.NumberingSeries(loftedplate.PartNumber.GetTSObject());
			set { loftedplate.PartNumber = value.GetTSObject(); }
		}

		public Dynamic.Tekla.Structures.Model.NumberingSeries AssemblyNumber
		{
			get => new Dynamic.Tekla.Structures.Model.NumberingSeries(loftedplate.AssemblyNumber.GetTSObject());
		...
		{
			get => new Dynamic.Tekla.Structures.Model.Position(loftedplate.Position.GetTSObject());
		...
		{
			get => new Dynamic.Tekla.Structures.Identifier(loftedplate.Identifier.GetTSObject());
        ...
        public LoftedPlate()
        {
            this.loftedplate =  new Tekla.Structures.Model.LoftedPlate();
        }
		...
		public System.Boolean GetAllUserProperties(ref System.Collections.Hashtable values)
			 => loftedplate.GetAllUserProperties(ref values);

		public System.Boolean GetIntegerUserProperties(ref System.Collections.Hashtable values)
			 => loftedplate.GetIntegerUserProperties(ref values);

		public System.Boolean GetDoubleUserProperties(ref System.Collections.Hashtable values)
			 => loftedplate.GetDoubleUserProperties(ref values);

		public System.Boolean GetStringUserProperties(ref System.Collections.Hashtable values)
			 => loftedplate.GetStringUserProperties(ref values);
		...
		public System.Boolean GetAllReportProperties(System.Collections.ArrayList stringNames, System.Collections.ArrayList doubleNames, System.Collections.ArrayList integerNames, ref System.Collections.Hashtable values)
			 => loftedplate.GetAllReportProperties(stringNames, doubleNames, integerNames, ref values);
		...
		public System.Boolean GetIntegerReportProperties(System.Collections.ArrayList names, ref System.Collections.Hashtable values)
			 => loftedplate.GetIntegerReportProperties(names, ref values);
		...
		public System.Boolean GetDoubleReportProperties(System.Collections.ArrayList names, ref System.Collections.Hashtable values)
			 => loftedplate.GetDoubleReportProperties(names, ref values);
		...
		public System.Boolean GetStringReportProperties(System.Collections.ArrayList names, ref System.Collections.Hashtable values)
			 => loftedplate.GetStringReportProperties(names, ref values);

		public System.Boolean GetUserProperty(System.String name, ref System.String value)
			 => loftedplate.GetUserProperty(name, ref value);

		public System.Boolean GetReportProperty(System.String name, ref System.String value)
			 => loftedplate.GetReportProperty(name, ref value);
		...
		public System.Boolean GetDynamicStringProperty(System.String name, ref System.String value)
			 => loftedplate.GetDynamicStringProperty(name, ref value);
		...
		public System.Boolean GetPhase(ref Dynamic.Tekla.Structures.Model.Phase phase)
			 => loftedplate.GetPhase(ref phase.GetTSObject());
