...
namespace Dynamic.Tekla.Structures.Geometry3d
{
    ...
    public sealed class OBB 
    {
		...
		{
			get => new Dynamic.Tekla.Structures.Geometry3d.Point(obb.Center.GetTSObject());
			set { obb.Center = value.GetTSObject(); }
		}

		public Dynamic.Tekla.Structures.Geometry3d.Vector Axis0
		{
			get => new Dynamic.Tekla.Structures.Geometry3d.Vector(obb.Axis0.GetTSObject());
			set { obb.Axis0 = value.GetTSObject(); }
		}

		public Dynamic.Tekla.Structures.Geometry3d.Vector Axis1
		{
			get => new Dynamic.Tekla.Structures.Geometry3d.Vector(obb.Axis1.GetTSObject());
			set { obb.Axis1 = value.GetTSObject(); }
		}

		public Dynamic.Tekla.Structures.Geometry3d.Vector Axis2
		{
			get => new Dynamic.Tekla.Structures.Geometry3d.Vector(obb.Axis2.GetTSObject());
