...
namespace Dynamic.Tekla.Structures.Model.UI
{
    ...
    public sealed class Picker 
    {
		...
		public System.Collections.ArrayList PickPoints(Dynamic.Tekla.Structures.Model.UI.PickPointEnum Enum)
			 => picker.PickPoints(Enum.GetTSObject());

		public System.Collections.ArrayList PickPoints(Dynamic.Tekla.Structures.Model.UI.PickPointEnum Enum, System.String Prompt)
		...
		public Dynamic.Tekla.Structures.Model.ModelObject PickObject(Dynamic.Tekla.Structures.Model.UI.PickObjectEnum Enum)
			 => new Dynamic.Tekla.Structures.Model.ModelObject(picker.PickObject(Enum.GetTSObject()));

		public Dynamic.Tekla.Structures.Model.ModelObject PickObject(Dynamic.Tekla.Structures.Model.UI.PickObjectEnum Enum, System.String Prompt)
			 => new Dynamic.Tekla.Structures.Model.ModelObject(picker.PickObject(Enum.GetTSObject(), Prompt));

		public Dynamic.Tekla.Structures.Model.ModelObjectEnumerator PickObjects(Dynamic.Tekla.Structures.Model.UI.PickObjectsEnum Enum)
			 => new Dynamic.Tekla.Structures.Model.ModelObjectEnumerator(picker.PickObjects(Enum.GetTSObject()));

		public Dynamic.Tekla.Structures.Model.ModelObjectEnumerator PickObjects(Dynamic.Tekla.Structures.Model.UI.PickObjectsEnum Enum, System.String Prompt)
