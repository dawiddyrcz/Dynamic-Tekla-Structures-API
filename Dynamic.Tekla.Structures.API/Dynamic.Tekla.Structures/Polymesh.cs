...
namespace Dynamic.Tekla.Structures.Model
{
    ...
    public sealed class Polymesh 
    {
		...
		{
			get => new Dynamic.Tekla.Structures.Geometry3d.FacetedBrep(polymesh.Brep.GetTSObject());
			set { polymesh.Brep = value.GetTSObject(); }
		}
        ...
        public Polymesh()
        {
            this.polymesh =  new Tekla.Structures.Model.Polymesh();
        }

        public Polymesh(dynamic tsObject)
        {
            this.polymesh = tsObject;
			this.Brep = new Dynamic.Tekla.Structures.Geometry3d.FacetedBrep(polymesh.Brep);

        }


        public dynamic GetTSObject() => polymesh;

		public void ConvertToStruct(Dynamic.Tekla.Structures.Geometry3d.FacetedBrep brep, ref Dynamic.Tekla.Structures.ModelInternal.dotPolymesh_t output)
			 => polymesh.ConvertToStruct(brep.GetTSObject(), ref output.GetTSObject());

		public System.String Fingerprint(Dynamic.Tekla.Structures.Geometry3d.FacetedBrep brep)
			 => polymesh.Fingerprint(brep.GetTSObject());
		...
		public System.Collections.Generic.ListTekla.Structures.Geometry3d.FacetedBrep<Dynamic.Tekla.Structures.Geometry3d.FacetedBrep> Convert(ref Dynamic.Tekla.Structures.ModelInternal.dotPolymesh_t input)
		...
		public void ToStruct(ref Dynamic.Tekla.Structures.ModelInternal.dotPolymesh_t output)
			 => polymesh.ToStruct(ref output.GetTSObject());
		...
		public System.Boolean Validate(Dynamic.Tekla.Structures.Geometry3d.FacetedBrep brep, Dynamic.Tekla.Structures.Model.Polymesh.PolymeshCheckerFlags checkCriteria, ref System.Collections.Generic.ListSystem.Collections.Generic.KeyValuePairSystem.Int32 invalidInfo)
		...
		public System.Collections.Generic.ListSystem.Collections.Generic.KeyValuePairSystem.Int32<System.Collections.Generic.KeyValuePairSystem.Int32<System.Int32, Dynamic.Tekla.Structures.Model.Polymesh.PolymeshHealthCheckEnum>> ConvertInvalidInfoFromStruct(ref Dynamic.Tekla.Structures.ModelInternal.dotPolymeshValidateInvalidInfo_t input)
    ...
    public static class PolymeshHealthCheckEnum_
    {
    ...
    public static class PolymeshCheckerFlags_
    {
