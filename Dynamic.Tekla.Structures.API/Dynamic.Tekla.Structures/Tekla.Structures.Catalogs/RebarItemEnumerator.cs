...
namespace Dynamic.Tekla.Structures.Catalogs
{
    ...
    public  class RebarItemEnumerator 
    {
		...
		{
			get => Dynamic.Tekla.Structures.Catalogs.RebarItem_.FromTSObject(teklaObject.Current);
		...
		public RebarItemEnumerator()
		{
			this.teklaObject = TSActivator.CreateInstance("Tekla.Structures.Catalogs.RebarItemEnumerator");
		}
