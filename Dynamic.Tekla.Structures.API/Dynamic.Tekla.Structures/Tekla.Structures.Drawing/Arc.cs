...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class ArcAttributes_
    {
        ...
        public static ArcAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.Arc.ArcAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class Arc_
    {
        ...
        public static Arc FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.Arc)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
