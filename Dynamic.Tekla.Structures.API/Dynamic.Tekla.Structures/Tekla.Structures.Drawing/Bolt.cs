...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class BoltAttributes_
    {
        ...
        public static BoltAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.Bolt.BoltAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class Bolt_
    {
        ...
        public static Bolt FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.Bolt)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
