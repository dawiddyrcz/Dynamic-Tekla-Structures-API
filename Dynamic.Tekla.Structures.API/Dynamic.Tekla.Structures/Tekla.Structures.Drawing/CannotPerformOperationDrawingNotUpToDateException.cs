...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    public  class CannotPerformOperationDrawingNotUpToDateException  : Dynamic.Tekla.Structures.Drawing.TeklaStructuresDrawingsApplicationException
    {
		...
		{
			this.teklaObject = TSActivator.CreateInstance("Tekla.Structures.Drawing.CannotPerformOperationDrawingNotUpToDateException");
		}
		//This constructor creates wrapper object using teklaObject. DateTime is never used but it is here to avoid conflicts with constructors with one argument
		public CannotPerformOperationDrawingNotUpToDateException(dynamic tsObject, System.DateTime nonConflictParameter)
		{
    ...
    internal static class CannotPerformOperationDrawingNotUpToDateException_
    {
        ...
        public static CannotPerformOperationDrawingNotUpToDateException FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Dynamic.Tekla.Structures.Drawing.CannotPerformOperationDrawingNotUpToDateException)System.Activator.CreateInstance(type, parameters);
