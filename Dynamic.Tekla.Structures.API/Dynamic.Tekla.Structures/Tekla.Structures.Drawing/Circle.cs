...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class CircleAttributes_
    {
        ...
        public static CircleAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.Circle.CircleAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class Circle_
    {
        ...
        public static Circle FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.Circle)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
