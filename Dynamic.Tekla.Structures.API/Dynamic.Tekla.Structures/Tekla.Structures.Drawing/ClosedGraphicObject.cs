...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class ClosedGraphicObjectAttributes_
    {
        ...
        public static ClosedGraphicObjectAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.ClosedGraphicObject.ClosedGraphicObjectAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class ClosedGraphicObject_
    {
        ...
        public static ClosedGraphicObject FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.ClosedGraphicObject)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
