...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class CloudAttributes_
    {
        ...
        public static CloudAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.Cloud.CloudAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class Cloud_
    {
        ...
        public static Cloud FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.Cloud)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
