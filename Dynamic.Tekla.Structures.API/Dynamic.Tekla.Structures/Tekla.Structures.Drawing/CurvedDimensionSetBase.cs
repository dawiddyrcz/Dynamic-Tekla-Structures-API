...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class CurvedDimensionSetBaseAttributes_
    {
        ...
        public static CurvedDimensionSetBaseAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.CurvedDimensionSetBase.CurvedDimensionSetBaseAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class CurvedDimensionSetBase_
    {
        ...
        public static CurvedDimensionSetBase FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.CurvedDimensionSetBase)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
