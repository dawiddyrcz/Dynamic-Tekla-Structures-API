...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class CurvedDimensionSetRadialAttributes_
    {
        ...
        public static CurvedDimensionSetRadialAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.CurvedDimensionSetRadial.CurvedDimensionSetRadialAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class CurvedDimensionSetRadial_
    {
        ...
        public static CurvedDimensionSetRadial FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.CurvedDimensionSetRadial)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
