...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class DetailMarkAttributes_
    {
        ...
        public static DetailMarkAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.DetailMark.DetailMarkAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class DetailMark_
    {
        ...
        public static DetailMark FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.DetailMark)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
