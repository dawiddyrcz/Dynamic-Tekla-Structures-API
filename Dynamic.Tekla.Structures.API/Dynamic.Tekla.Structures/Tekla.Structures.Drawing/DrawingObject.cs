...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class NoAttributes_
    {
        ...
        public static NoAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.DrawingObject.NoAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class DrawingObject_
    {
        ...
        public static DrawingObject FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.DrawingObject)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
