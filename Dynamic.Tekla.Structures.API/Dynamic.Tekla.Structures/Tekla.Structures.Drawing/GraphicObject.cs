...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class GraphicObjectAttributes_
    {
        ...
        public static GraphicObjectAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.GraphicObject.GraphicObjectAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class GraphicObject_
    {
        ...
        public static GraphicObject FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.GraphicObject)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
