...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class GridAttributes_
    {
        ...
        public static GridAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.Grid.GridAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class Grid_
    {
        ...
        public static Grid FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.Grid)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
