...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    public  class InvalidTypeException  : Dynamic.Tekla.Structures.Drawing.TeklaStructuresDrawingsApplicationException
    {
		...
		{
			this.teklaObject = TSActivator.CreateInstance("Tekla.Structures.Drawing.InvalidTypeException");
		}
		//This constructor creates wrapper object using teklaObject. DateTime is never used but it is here to avoid conflicts with constructors with one argument
		public InvalidTypeException(dynamic tsObject, System.DateTime nonConflictParameter)
		{
    ...
    internal static class InvalidTypeException_
    {
        ...
        public static InvalidTypeException FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Dynamic.Tekla.Structures.Drawing.InvalidTypeException)System.Activator.CreateInstance(type, parameters);
