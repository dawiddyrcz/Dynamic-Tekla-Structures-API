...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    public  class Line  : Dynamic.Tekla.Structures.Drawing.OpenGraphicObject
    {
		...
		public Dynamic.Tekla.Structures.Drawing.Line.LineAttributes Attributes
		{
			...
			{
				try {
				return Dynamic.Tekla.Structures.Drawing.Line.LineAttributes_.FromTSObject(teklaObject.Attributes);
				} catch (Microsoft.CSharp.RuntimeBinder.RuntimeBinderException ex)
			...
			{
				try {
				teklaObject.Attributes = Dynamic.Tekla.Structures.Drawing.Line.LineAttributes_.GetTSObject(value);
				} catch (Microsoft.CSharp.RuntimeBinder.RuntimeBinderException ex)
				 { throw DynamicAPINotFoundException.CouldNotFindProperty("Attributes", ex); }
			}
		}
