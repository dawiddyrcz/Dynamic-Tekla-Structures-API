...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class LineAttributes_
    {
        ...
        public static LineAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.Line.LineAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class Line_
    {
        ...
        public static Line FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.Line)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
