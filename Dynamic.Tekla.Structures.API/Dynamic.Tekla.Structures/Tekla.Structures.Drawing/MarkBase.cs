...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class MarkBaseAttributes_
    {
        ...
        public static MarkBaseAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.MarkBase.MarkBaseAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class MarkBase_
    {
        ...
        public static MarkBase FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.MarkBase)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
