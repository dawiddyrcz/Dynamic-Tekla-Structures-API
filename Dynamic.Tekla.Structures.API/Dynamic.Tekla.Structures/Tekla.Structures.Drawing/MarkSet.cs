...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class MarkSetAttributes_
    {
        ...
        public static MarkSetAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.MarkSet.MarkSetAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class MarkSet_
    {
        ...
        public static MarkSet FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.MarkSet)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
