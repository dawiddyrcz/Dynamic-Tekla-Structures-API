...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class OpenGraphicObjectAttributes_
    {
        ...
        public static OpenGraphicObjectAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Dynamic.Tekla.Structures.Drawing.OpenGraphicObject.OpenGraphicObjectAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class OpenGraphicObject_
    {
        ...
        public static OpenGraphicObject FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Dynamic.Tekla.Structures.Drawing.OpenGraphicObject)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
