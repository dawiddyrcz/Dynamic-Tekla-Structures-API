...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class PartAttributes_
    {
        ...
        public static PartAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.Part.PartAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class Part_
    {
        ...
        public static Part FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.Part)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
