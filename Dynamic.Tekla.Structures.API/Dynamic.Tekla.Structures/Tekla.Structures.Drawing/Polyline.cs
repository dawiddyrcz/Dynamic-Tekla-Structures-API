...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    public  class Polyline  : Dynamic.Tekla.Structures.Drawing.OpenGraphicObject
    {
		...
		{
			get => Dynamic.Tekla.Structures.Drawing.Polyline.PolylineAttributes_.FromTSObject(teklaObject.Attributes);
			set { teklaObject.Attributes = Dynamic.Tekla.Structures.Drawing.Polyline.PolylineAttributes_.GetTSObject(value); }
		}
    ...
    internal static class PolylineAttributes_
    {
        ...
        public static PolylineAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.Polyline.PolylineAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class Polyline_
    {
        ...
        public static Polyline FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.Polyline)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
