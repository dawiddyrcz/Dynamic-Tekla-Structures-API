...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class PourAttributes_
    {
        ...
        public static PourAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.PourObject.PourAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class PourObject_
    {
        ...
        public static PourObject FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.PourObject)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
