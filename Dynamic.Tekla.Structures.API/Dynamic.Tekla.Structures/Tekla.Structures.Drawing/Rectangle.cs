...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class RectangleAttributes_
    {
        ...
        public static RectangleAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.Rectangle.RectangleAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class Rectangle_
    {
        ...
        public static Rectangle FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.Rectangle)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
