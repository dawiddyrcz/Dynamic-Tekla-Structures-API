...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class ReferenceModelAttributes_
    {
        ...
        public static ReferenceModelAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.ReferenceModel.ReferenceModelAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class ReferenceModel_
    {
        ...
        public static ReferenceModel FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.ReferenceModel)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
