...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class ReinforcementSingleAttributes_
    {
        ...
        public static ReinforcementSingleAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Dynamic.Tekla.Structures.Drawing.ReinforcementBase.ReinforcementSingleAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class ReinforcementGroupAttributes_
    {
        ...
        public static ReinforcementGroupAttributes FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Dynamic.Tekla.Structures.Drawing.ReinforcementBase.ReinforcementGroupAttributes)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
    ...
    internal static class ReinforcementBaseAttributes_
    {
        ...
        public static ReinforcementBaseAttributes FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Dynamic.Tekla.Structures.Drawing.ReinforcementBase.ReinforcementBaseAttributes)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
