...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class StraightDimensionAttributes_
    {
        ...
        public static StraightDimensionAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.StraightDimension.StraightDimensionAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class StraightDimension_
    {
        ...
        public static StraightDimension FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.StraightDimension)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
