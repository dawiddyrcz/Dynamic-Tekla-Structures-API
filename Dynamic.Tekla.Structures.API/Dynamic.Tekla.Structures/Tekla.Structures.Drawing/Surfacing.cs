...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class SurfacingAttributes_
    {
        ...
        public static SurfacingAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.Surfacing.SurfacingAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class Surfacing_
    {
        ...
        public static Surfacing FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.Surfacing)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
