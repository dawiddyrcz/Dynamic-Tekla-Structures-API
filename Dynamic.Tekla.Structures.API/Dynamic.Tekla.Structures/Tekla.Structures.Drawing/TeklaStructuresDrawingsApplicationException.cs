...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    public  class TeklaStructuresDrawingsApplicationException 
    {
		...
		public TeklaStructuresDrawingsApplicationException() {}
    ...
    internal static class TeklaStructuresDrawingsApplicationException_
    {
        ...
        public static TeklaStructuresDrawingsApplicationException FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Dynamic.Tekla.Structures.Drawing.TeklaStructuresDrawingsApplicationException)System.Activator.CreateInstance(type);
