...
namespace Dynamic.Tekla.Structures.Drawing
{
    ...
    internal static class TextAttributes_
    {
        ...
        public static TextAttributes FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Tekla.Structures.Drawing.Text.TextAttributes)System.Activator.CreateInstance(type);
    ...
    internal static class Text_
    {
        ...
        public static Text FromTSObject(dynamic tsObject)
        {
            var typeName = "Dynamic." + tsObject.GetType().FullName;
            var type = System.Reflection.Assembly.GetExecutingAssembly().GetType(typeName);
            var dynObject = (Tekla.Structures.Drawing.Text)System.Activator.CreateInstance(type);
            dynObject.teklaObject = tsObject;
            return dynObject;
        }
    }
