...
namespace Dynamic.Tekla.Structures.Model
{
    ...
    public sealed class InvalidFacePointsException 
    {
		...
		{
			get => Dynamic.Tekla.Structures.Model.BentPlateGeometrySolver.OperationStatus_.FromTSObject(invalidfacepointsexception.OperationStatus);
			set { invalidfacepointsexception.OperationStatus = Dynamic.Tekla.Structures.Model.BentPlateGeometrySolver.OperationStatus_.GetTSObject(value); }
		}
