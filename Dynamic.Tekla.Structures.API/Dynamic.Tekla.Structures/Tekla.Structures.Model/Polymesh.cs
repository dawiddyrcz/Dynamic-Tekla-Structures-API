...
namespace Dynamic.Tekla.Structures.Model
{
    ...
    public  class Polymesh 
    {
		...
		public Dynamic.Tekla.Structures.Geometry3d.FacetedBrep Brep
		{
			get
			{
				...
				return Dynamic.Tekla.Structures.Geometry3d.FacetedBrep_.FromTSObject(teklaObject.Brep);
				 ...
				 { throw DynamicAPINotFoundException.CouldNotFindProperty("Brep"); }
			}
			set
			{
				try {
		...
		public static System.Boolean GetSolidBrep(Dynamic.Tekla.Structures.Geometry3d.FacetedBrep inBrep, out Dynamic.Tekla.Structures.Geometry3d.FacetedBrep outBrep)
		{
			var parameters = new object[2];
    ...
    internal static class Polymesh_
    {
        ...
        public static Polymesh FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Dynamic.Tekla.Structures.Model.Polymesh)System.Activator.CreateInstance(type, parameters);
