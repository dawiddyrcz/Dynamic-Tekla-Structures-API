...
namespace Dynamic.Tekla.Structures.Model
{
    ...
    public  class RebarLeg 
    {
        ...
        public Dynamic.Tekla.Structures.Model.RebarLeg.OriginEnum Origin
        {
            get
            {
                try
                ...
                var value_ = Dynamic.Tekla.Structures.Model.RebarLeg.OriginEnum_.FromTSObject(value);
                return (Dynamic.Tekla.Structures.Model.RebarLeg.OriginEnum) value_;
                }
                catch (Microsoft.CSharp.RuntimeBinder.RuntimeBinderException ex)
                {
    ...
    internal static class RebarLeg_
    {
        ...
        public static RebarLeg FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (Dynamic.Tekla.Structures.Model.RebarLeg)System.Activator.CreateInstance(type, parameters);
